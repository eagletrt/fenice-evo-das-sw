 ...
 *
 * \details The module owns one PAL handler per network. All wiring goes like
 * this Lifecycle (per network):
...
can_communications_api_init(const struct CanCommunicationsNetworkConfig
                                configs[CAN_COMMUNICATION_NETWORK_COUNT]);
 ...
 */
enum CanCommunicationReturnCode can_communications_api_add_to_tx_buffer(
 ...
 */
enum CanCommunicationReturnCode
can_communications_api_process_tx(enum CanCommunicationNetwork network);
 ...
 */
enum CanCommunicationReturnCode
can_communications_api_process_rx(enum CanCommunicationNetwork network);
