...
uint8_t _INV_READ_REG_QUEUE_LEN                = 16;
INV_RegMetadataTypeDef _INV_READ_REG_QUEUE[16] = {
...
float INV_get_IGBT_temp(INV_SideTypeDef side) {
    ...
    return -43.23745 + 0.01073427 * raw_temp - 5.523417e-7 * pow(raw_temp, 2) + 1.330787e-11 * pow(raw_temp, 3);
}
